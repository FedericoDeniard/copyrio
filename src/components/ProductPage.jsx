    ...
    <div className="animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
        ...
        <div className="lg:col-span-8">
          <div className="p-1 rounded-xl border border-accents-2 bg-accents-1">
            <div className="relative overflow-hidden rounded-lg bg-black flex justify-center items-center min-h-[400px]">
              <img 
                src={image} 
                alt={alt || title} 
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="p-8 rounded-xl border border-accents-2 bg-background flex flex-col items-start">
          ...
          <div className="p-6 rounded-xl border border-accents-2 bg-accents-1/30 flex items-center gap-4">
